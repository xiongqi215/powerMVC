            ...
            <div class="vip-content">
                <table id="yh" class="vip-info">
                    <%-- <tr>
                        ...
                        <td wdith="520">${informationForm.information.countryCName}</td>
                    </tr>
                    <tr>
                        <th>帐号</th>
                        <td>${informationForm.information.login}</td>
                    </tr>
                    <tr>
                        <th>所属国家</th>
                        <td>中华人民共和国</td>
                    ...
                    <tr>
                        <th>联系方式</th>
                        <td>${informationForm.information.tele}</td>
                    </tr>
                    <tr>
                        <th>联系人</th>
                        <td>${informationForm.information.contacts}</td>
                    </tr>
                    <tr>
                        <th>电子邮箱</th>
                        <td>${informationForm.information.email}</td>
                    </tr>
                    <tr>
                        <th>通讯地址</th>
                        <td>${informationForm.information.address}</td>
                    </tr> --%>
                </table>
