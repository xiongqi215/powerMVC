            ...
            <form id="memberInputForm" >
                <table class="vip-info">
                    ...
                    <tr>
                        ...
                        <td wdith="520"><input type="text" value="${member.memberCName}" name="memberCName" class="divInput"></td>
                    </tr>
                    <tr>
                        <th>帐号</th>
                        <td><input type="text" value="${member.login}" name="login" class="divInput w205"><a class="changePW"  onclick="revice()" href="#">修改密码</a></td>
                    </tr>
                    <tr id="pass" style="display: none">
                        <th>新密码</th>
                        <td><input id="newPass" type="text" value="${member.password}" name="password" class="divInput"></td>
                    </tr>
                    <tr>
                        <th>所属国家</th>
                    ...
                    <tr>
                        <th>联系方式</th>
                        <td><input type="text" value="${member.tele}" name="tele" class="divInput"></td>
                    </tr>
                    <tr>
                        <th>联系人</th>
                        <td><input type="text" value="${member.contacts}" name="contacts" class="divInput"></td>
                    </tr>
                    <tr>
                        <th>电子邮箱</th>
                        <td><input type="text" value="${member.email}" name="email" class="divInput"></td>
                    </tr>
                    <tr>
                        <th>通讯地址</th>
                        <td><input type="text" value="${member.address}" name="address" class="divInput"></td>
                    </tr>
                    <tr><input type="text" style="display:none" value="${member.memberId}" name="memberId" ></input></tr>
                </table>
