...
<link rel="stylesheet"href="${ctx}/css/bootstrap3.3.5.css" />
<link rel="stylesheet"href="${ctx}/css/self.css" />
...
<script type="text/javascript" src="${ctx}/js/web.js" charset="utf-8"></script>
<script type="text/javascript" src="${ctx}/js/highcharts/highcharts.js" charset="utf-8"></script>
<script type="text/javascript" src="${ctx}/js/jquery.form.min.js" charset="utf-8"></script>
<script type="text/javascript" src="${ctx}/js/jquery.min.js" charset="utf-8"></script>
<script  type="text/javascript" src="${ctx}/js/bootstrap3.3.5.js" charset="utf-8"></script> 
